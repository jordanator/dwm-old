...
static const char *fonts[]          = { "Hack Nerd Font:size=13", "JoyPixels:pixelsize=14:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask|ShiftMask, XK_b,      spawn,		   SHCMD("feh --bg-max --randomize ~/Downloads/bec/* &") },
	...
	{ MODKEY|ShiftMask,			    XK_s,      spawn,		   SHCMD("flameshot full -p ~/Pictures/screenshots") },
